...
class BatchRewardManager:
    ...
    def verify(self, data):
        ...
        # Store metrics in data for later retrieval
        # if not hasattr(data, 'meta_info'):
        #     data.meta_info = {}
        # if 'metrics' not in data.meta_info:
        #     data.meta_info['metrics'] = {}
        # data.meta_info['metrics'].update(score_metrics)
    ...
    def __call__(self, data: DataProto, return_dict=False):
        ...
        if return_dict:
            ...
            # Include metrics in the return dict if they exist
            if hasattr(data, 'meta_info') and 'metrics' in data.meta_info:
                result["metrics"] = data.meta_info['metrics']
            return result
        else:
