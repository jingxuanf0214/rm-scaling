...
try:
    ...
    # Define functions locally if verl import fails
...
def main():
    ...
    # Check if local_dir already ends with huggingface to avoid duplicate
    if args.local_dir.endswith("huggingface"):
